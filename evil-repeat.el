...
(evil--local-advice-add 'read-key-sequence :before #'evil--read-key-sequence-advice)
(evil--local-advice-add 'read-key-sequence-vector :before #'evil--read-key-sequence-advice)
